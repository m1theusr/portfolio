    ...
    <div>
      ...
      >
        <div className="max-w-7xl container mx-auto px-1">
          ...
          <p class="relative flex items-center text-2xl">
            I'm&nbsp;
            <span
              class="overflow-hidden border-r-2 border-[rgb(251,255,0)] whitespace-nowrap max-w-[13ch] animate-typing text-2xl font-bold text-white"
            >
              <span class="block group-[data-text='0']:block group-[data-text='1']:hidden">
                DevOps Engineer
              </span>
              <span class="hidden group-[data-text='1']:block group-[data-text='0']:hidden">
                SRE
              </span>
            </span>
          </p>
