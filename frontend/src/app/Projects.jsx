...
export default function CaseStudyCard() {
  ...
  const projects = [
    ...
    {
      title: "Data Orchestration with Airflow, Airbyte, and dbt",
      description: "Data extraction, transformation, and loading (ETL) pipeline using Apache Airflow, designed to process and analyze data from various sources.",
      link: "https://github.com/m1theusr/etl-airflow",
    },
  ];
